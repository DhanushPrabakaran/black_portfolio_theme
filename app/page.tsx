...
export default function Home() {
  ...
  <div className=" flex max-md:items-center  flex-col min-md:w-1/2">
            <div
    ...
    <svg viewBox="0 0 655 680" fill="none" className="h-full min-md:w-1/2 px-2">
        <g clip-path="url(#:S1:-clip)" className="group">
          <g className="origin-center scale-100 transition duration-500 motion-safe:group-hover:scale-105 ">
            <foreignObject width="655" height="680" className='' >
              <Image alt="" loading="lazy" width="2400" height="3000" decoding="async" data-nimg="1" className="w-full object-cover" sizes="(min-width: 1024px) 41rem, 31rem" src={iam} />
            </foreignObject>
          </g>
