...
const About = () => {
  return (
    ...
    //   style={{
    //     backgroundImage:
    //       "url(https://i.pinimg.com/originals/e2/8d/61/e28d61b0ce1b686bbd9c19b98912101f.gif)",
    //   }}
    >
        ...
        <div className="   flex items-center flex-col justify-center  ">
          <div className=" h-fit   card w-full bg-black ">
            {/* <Image
                ...
                alt="Computer"
                width={130}
                className=" absolute self-center -translate-y-1/2   rounded-full bg-transparent   "
              /> */}
            <div className=" flex flex-col lg:flex-row  items-center">
                <div
                className=" card-body w-full h-full ">
              {/* <h2 className=" text-center card-title mt-8 ">
                Dhanush Prabakaran
              </h2> */}
              <svg
                viewBox="0 0 655 680"
              ...
              <p
              className=" max-md:text-center p-1 font-black lg:text-xl">
                As a{" "}
